...
var myPlot = document.getElementById('web_error_graph_18');
...
function initialize()
{
    var layout =
    {
        title: '<b>[-1, 1]<sup>2</sup> Domain</b><br>d = 2, p = 2<br>u(x<sub>1</sub>, x<sub>2</sub>) = (x<sub>1</sub> + x<sub>2</sub>)<sup>4</sup>cos(x<sub>1</sub>(x<sub>1</sub> + 2x<sub>2</sub>))',
        hovermode:'closest',
        xaxis:
        {
            type: 'log',
